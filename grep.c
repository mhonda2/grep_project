...
char	*globp, *tfname, *tfname, *loc1, *loc2;
char	ibuff[BLKSIZE], obuff[BLKSIZE], WRERR[]	= "WRITE ERROR";
int	ichanged, nleft, anymarks, nbra, subnewa, subolda, fchange, wrapp, bpagesize = 20;
int	names[26];
char	*braslist[NBRA], *braelist[NBRA], tmpXXXXX[50] = "/tmp/eXXXXX";
unsigned nlall = 128;
